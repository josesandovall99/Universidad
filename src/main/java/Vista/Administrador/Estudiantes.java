...
public class Estudiantes extends javax.swing.JFrame {
    ...
    public Estudiantes() {
        ...
        a.visualizarEstudiante(tablaSem,opcion,valorbus);
    ...
    private void agregarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_agregarbtActionPerformed
        ...
        sem.InsetarEstudiante(nombretxt, emailtxt, telefonotxt,dirtxt);
        int opcion = comboOpcion.getSelectedIndex();
        String valorbus = campoBuscar.getText();
        sem.visualizarEstudiante(tablaSem,opcion,valorbus);
    ...
    private void modificarbtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_modificarbtActionPerformed
        ...
        Estudiante sem = new Estudiante();
        sem.modificarEstudiante(idtxt,nombretxt, emailtxt, telefonotxt,dirtxt);
        int opcion = comboOpcion.getSelectedIndex();
        String valorbus = campoBuscar.getText();
        sem.visualizarEstudiante(tablaSem,opcion,valorbus);
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        EstudiantesDesactivados o = new EstudiantesDesactivados();
        o.setVisible(true);
        dispose();
