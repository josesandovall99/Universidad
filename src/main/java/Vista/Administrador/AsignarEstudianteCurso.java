 ...
 */
public class AsignarEstudianteCurso extends javax.swing.JFrame {

    /**
     * Creates new form AsignarEstudianteCurso
     */
    public AsignarEstudianteCurso() {
        initComponents();
        
        new Estudiante().visualizarEstudiante(tablaSem, 0, null);
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new Curso().asignarEstudiantes(txtcod, idtxt);
        new Estudiante().visualizarEstudiante(tablaSem, 0, null);
        new Curso().visualizarCurso(tablaCur, 0, null);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AsignarEstudianteCurso.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
