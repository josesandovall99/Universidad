 ...
 */
public class ProfesoresDesactivados extends javax.swing.JFrame {

    /**
     * Creates new form ProfesoresDesactivados
     */
    public ProfesoresDesactivados() {
        initComponents();
        ...
        a.visualizarProfesorDesactivado(tablaSem,opcion,valorbus);
    ...
    private void initComponents() {
        ...
        jLabel5.setText("SISTEMA PARA ADMINISTRADORES - Profesores Desactivados");
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        int opcion = comboOpcion.getSelectedIndex();
        String valorbus = campoBuscar.getText();
        sem.visualizarProfesorDesactivado(tablaSem,opcion,valorbus);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesoresDesactivados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfesoresDesactivados().setVisible(true);
            }
        });
    }
