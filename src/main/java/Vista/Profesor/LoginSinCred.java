 ...
 */
public class LoginSinCred extends javax.swing.JFrame {

    /**
     * Creates new form LoginSinCred
     */
    public LoginSinCred() {
        initComponents();
    }
    ...
    private void volvtxtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_volvtxtActionPerformed
        ...
        SesionProfesor a = new SesionProfesor();
        a.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginSinCred.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginSinCred().setVisible(true);
            }
        });
    }
