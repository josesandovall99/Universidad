 ...
 */
public class ProfesorHorario extends javax.swing.JFrame {

    /**
     * Creates new form ProfesorHorario
     */
    public ProfesorHorario() {
        initComponents();
    }
    
    public ProfesorHorario(String codigo) {
        initComponents();
        
        usuariotxt.setText(codigo);
        new Profesor().verHorario(jTable1, codigo);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 110, 890, 460));
        ...
        getContentPane().add(jButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 580, 170, 40));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        new PrincipalProfesor(usuariotxt.getText()).setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProfesorHorario.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ProfesorHorario().setVisible(true);
            }
        });
    }
