 ...
 */
public class CursosProfesor extends javax.swing.JFrame {

    /**
     * Creates new form CursosProfesor
     */
    ...
    public CursosProfesor(String id) {
        initComponents();
       
        usuariotxt.setText(id);
        new Profesor().verCursos(tablaCurso, usuariotxt.getText());
