 ...
 */
public class SesionSinRolEstudiante extends javax.swing.JFrame {

    /**
     * Creates new form SesionSinRolEstudiante
     */
    public SesionSinRolEstudiante() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(SesionSinRolEstudiante.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SesionSinRolEstudiante().setVisible(true);
            }
        });
    }
