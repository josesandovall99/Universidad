 ...
 */
public class BuilderCursos implements CodigoBuilder {
    
    public String ciudad = "CT";
    public String numeroCaracteristico = "03";
    public String año;
    public String numerosfinales;

    public BuilderCursos(String año, String numerosfinales) {
        this.año = año;
        this.numerosfinales = numerosfinales;
    }

    public BuilderCursos() {
    }
    ...
    public CodigoCursos getResult() {

        return new CodigoCursos(ciudad, numeroCaracteristico, año, numerosfinales);
