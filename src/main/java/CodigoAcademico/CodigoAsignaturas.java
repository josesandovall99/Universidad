 ...
 */
public class CodigoAsignaturas {
    public String ciudad;
    public String numeroCaracteristico;
    public String año;
    public String numerosfinales;

    public CodigoAsignaturas() {
    }

    public CodigoAsignaturas(String ciudad, String numeroCaracteristico, String año, String numerosfinales) {
        this.ciudad = ciudad;
