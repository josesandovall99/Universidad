 ...
 */
public class CodigoProfesores {
    public String ciudad;
    public String numeroCaracteristico;
    public String año;
    public String numerosfinales;

    public CodigoProfesores() {
    }

    public CodigoProfesores(String ciudad, String numeroCaracteristico, String año, String numerosfinales) {
        this.ciudad = ciudad;
