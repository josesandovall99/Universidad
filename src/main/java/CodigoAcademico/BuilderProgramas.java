 ...
 */
public class BuilderProgramas implements CodigoBuilder {
    
    public String ciudad = "CT";
    public String numeroCaracteristico = "07";
    public String año;
    public String numerosfinales;

    public BuilderProgramas(String año, String numerosfinales) {
        this.año = año;
        this.numerosfinales = numerosfinales;
    }

    public BuilderProgramas() {
    }
    ...
    public CodigoProgramas getResult() {

        return new CodigoProgramas(ciudad, numeroCaracteristico, año, numerosfinales);
