 ...
 */
public class BuilderAdministradores implements CodigoBuilder {
    
    public String ciudad = "CUC";
    public String numeroCaracteristico = "01";
    public String año;
    public String numerosfinales;

    public BuilderAdministradores(String año, String numerosfinales) {
        this.año = año;
        this.numerosfinales = numerosfinales;
    }

    public BuilderAdministradores() {
    }
    ...
    public CodigoAdministradores getResult() {

        return new CodigoAdministradores(ciudad, numeroCaracteristico, año, numerosfinales);
