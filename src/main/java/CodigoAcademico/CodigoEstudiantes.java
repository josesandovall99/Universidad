 ...
 */
public class CodigoEstudiantes {
    public String ciudad;
    public String numeroCaracteristico;
    public String año;
    public String numerosfinales;

    public CodigoEstudiantes() {
    }

    public CodigoEstudiantes(String ciudad, String numeroCaracteristico, String año, String numerosfinales) {
        this.ciudad = ciudad;
