 ...
 */
public class BuilderAsignaturas implements CodigoBuilder {
    
    public String ciudad = "CT";
    public String numeroCaracteristico = "02";
    public String año;
    public String numerosfinales;

    public BuilderAsignaturas(String año, String numerosfinales) {
        this.año = año;
        this.numerosfinales = numerosfinales;
    }

    public BuilderAsignaturas() {
    }
    ...
    public CodigoAsignaturas getResult() {

        return new CodigoAsignaturas(ciudad, numeroCaracteristico, año, numerosfinales);
