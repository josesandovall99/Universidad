 ...
 */
public class BuilderProfesores implements CodigoBuilder {
    
    public String ciudad = "CUC";
    public String numeroCaracteristico = "06";
    public String año;
    public String numerosfinales;

    public BuilderProfesores(String año, String numerosfinales) {
        this.año = año;
        this.numerosfinales = numerosfinales;
    }

    public BuilderProfesores() {
    }
    ...
    public CodigoProfesores getResult() {

        return new CodigoProfesores(ciudad, numeroCaracteristico, año, numerosfinales);
