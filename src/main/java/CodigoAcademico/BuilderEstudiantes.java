 ...
 */
public class BuilderEstudiantes implements CodigoBuilder {
    
    public String ciudad = "CUC";
    public String numeroCaracteristico = "04";
    public String año;
    public String numerosfinales;

    public BuilderEstudiantes(String año, String numerosfinales) {
        this.año = año;
    ...
    public CodigoEstudiantes getResult() {

        return new CodigoEstudiantes(ciudad, numeroCaracteristico,  año, numerosfinales);
