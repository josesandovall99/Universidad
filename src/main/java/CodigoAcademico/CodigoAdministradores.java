 ...
 */
public class CodigoAdministradores {
    ...
    public CodigoAdministradores() {
    }

    public CodigoAdministradores(String ciudad, String numeroCaracteristico, String año, String numerosfinales) {
        this.ciudad = ciudad;
