 ...
 */
public class CorreoAdministradorCredenciales implements CorreoCredenciales {
    ...
    public CorreoAdministradorCredenciales() {
    ...
    public void createEmail(String emailTo, String id, String contraseña) {
        ...
        //cuerpo del correo
        String subject ="CREDENCIALES ADMINISTRADOR - UNIVERSIDAD";
    ...
    public void realizarEnvioCorreo(String emailTo, String id, String contraseña){
    
        createEmail(emailTo,id,contraseña);
        sendEmail();
